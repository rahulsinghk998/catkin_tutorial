//This program subscribes data published by <publisher_talker> node.

#include "ros/ros.h"
#include "std_msgs/String.h"
#include <sstream>

void callbackforsubscribe(const std_msgs::String::ConstPtr& msg)
{
...
int main(int argc,char **argv)
{
	...
	ros::NodeHandle nh;
	ros::Subscriber node_subs=nh.subscribe("chatter",100,callbackforsubscribe);
	ros::spin();
return 0;
...
*  ros::spinOnce() is eqivalent to this line of code.
